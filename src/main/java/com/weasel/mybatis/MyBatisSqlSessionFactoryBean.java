...
import com.weasel.mybatis.help.MergeConfigurationXmlHelper;
...
public class MyBatisSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
	 ...
	 */
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException, DocumentException {
		
		Configuration configuration = null;
		XMLConfigBuilder xmlConfigBuilder = null;
		Document document = MergeConfigurationXmlHelper.merge(configLocations);
